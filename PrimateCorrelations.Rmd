...
```{r}
#NSA, positive correlation, 0.6446429
#FTA, positive correlation, 0.65894
#SUP, negative correlation, -0.5079504
...
```{r}
# This means that the Neck Shaft Angle and the Fobia Trochanteric Angle primate bone morphologies have a close relationship to abduction, which is a primate range of motion measurement. So, primates with bigger NSA and FTA angles are more abducted. SUP is negatively correlated with Abduction, so as abduction increases, SUP decreases. 
